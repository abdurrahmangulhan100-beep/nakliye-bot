      ...
      <html>
        ...
        <body>
          <div class="card">
            ...
            <div class="badge">⚡ Stabil QR Modu Aktif</div><br>
    ...
    res.end(`
      ...
      <html>
        <body style="font-family:sans-serif; text-align:center; padding-top:50px; background:#f0f2f5;">
          ...
          <p>Lütfen sayfayı 3 saniye sonra yenileyin...</p>
...
// --- 3. HAFIZA BAZLI VE ARKA PLAN YAZMALI SESSION YÖNETİCİSİ ---
...
async function botuBaslat() {
  ...
  const sock = makeWASocket({
    ...
    // TIMEOUT VE KİLİTLENMEYİ ENGELLEYEN KRİTİK AYARLAR:
